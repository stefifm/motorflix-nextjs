...
export default async function MotorVideo (): Promise<JSX.Element> {
  ...
  return (
    <section className='w-full h-[55vh] lg:h-[60vh] justify-start items-center'>
      <video
        ...
        className='w-full absolute top-0 left-0 object-cover h-[60vh] -z-10 brightness-[60%]'></video>

      <div className='absolute w-[90%] lg:w-[40%] mx-auto top-[30%]'>
